...
:GETOPTS
  ...
  IF /I [%1] == [--cf-url] SET CF_URL=%2& SHIFT
  IF /I [%1] == [--cf-user] SET CF_USER=%2& SHIFT
  IF /I [%1] == [--cf-password] SET CF_PASSWORD=%2& SHIFT
  IF /I [%1] == [--cf-org] SET CF_ORG=%2& SHIFT
  IF /I [%1] == [--cf-space] SET CF_SPACE=%2& SHIFT
