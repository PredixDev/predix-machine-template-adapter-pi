...
mvn -f GrovePi-spec/pom.xml build-helper:parse-version versions:set -B -DnewVersion="\${parsedVersion.majorVersion}.\${parsedVersion.minorVersion}.\${parsedVersion.incrementalVersion}"
...
mvn -f Pi-spec/pom.xml build-helper:parse-version versions:set -B -DnewVersion="\${parsedVersion.majorVersion}.\${parsedVersion.minorVersion}.\${parsedVersion.incrementalVersion}"
...
mvn -f GrovePi-pi4j/pom.xml build-helper:parse-version versions:set -B -DnewVersion="\${parsedVersion.majorVersion}.\${parsedVersion.minorVersion}.\${parsedVersion.incrementalVersion}"
...
mvn -f GrovePi-dio/pom.xml build-helper:parse-version versions:set -B -DnewVersion="\${parsedVersion.majorVersion}.\${parsedVersion.minorVersion}.\${parsedVersion.incrementalVersion}"
...
mvn -f Pi-dio/pom.xml build-helper:parse-version versions:set -B -DnewVersion="\${parsedVersion.majorVersion}.\${parsedVersion.minorVersion}.\${parsedVersion.incrementalVersion}"
...
mvn -f Pi-pi4j/pom.xml build-helper:parse-version versions:set -B -DnewVersion="\${parsedVersion.majorVersion}.\${parsedVersion.minorVersion}.\${parsedVersion.incrementalVersion}"
...
mvn -f ProjectStub/pom.xml build-helper:parse-version versions:set -B -DnewVersion="\${parsedVersion.majorVersion}.\${parsedVersion.minorVersion}.\${parsedVersion.incrementalVersion}"
...
mvn -f examples/pom.xml build-helper:parse-version versions:set -B -DnewVersion="\${parsedVersion.majorVersion}.\${parsedVersion.minorVersion}.\${parsedVersion.incrementalVersion}"
